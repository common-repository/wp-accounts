...
if (!class_exists('wpaCommon')) {
	...
	class wpaCommon {
        ...
        public static $plugin_name = 'WP Accounts';
        public static $plugin_prefix = 'wp_accounts';
        public static $plugin_text_domain = 'wp-accounts';
		...
		public static function plugin_version() {
            ...
            return wpaccounts_class::$version;
